...
if YAML_AVAILABLE:
    ...
    def validate_config_value(k, v):
        return v

    def validate_instance_id(i):
        return i
...
class TestConfigManager(unittest.TestCase):
    ...
    def test_set_and_get_action_enabled(self):
        ...
        self.assertTrue(self.config_manager.set_action_enabled("delete_nat_gateway", False))
        self.assertFalse(self.config_manager.get_action_enabled("delete_nat_gateway"))
        # other types untouched
        self.assertTrue(self.config_manager.get_action_enabled("stop_instance"))
        self.assertTrue(self.config_manager.set_action_enabled("delete_nat_gateway", True))
        self.assertTrue(self.config_manager.get_action_enabled("delete_nat_gateway"))
...
class TestConfigLimits(unittest.TestCase):
    ...
    def test_min_less_than_max(self):
        ...
        for key, limits in CONFIG_LIMITS.items():
            self.assertLessEqual(limits["min"], limits["max"], f"{key}: min should be <= max")
