...
from utils.remediator import get_backend_path, validate_backend_at_startup, sanitize_for_json
...
class TestConfigManagerIntegration(unittest.TestCase):
    ...
    def setUp(self):
        ...
        self.sample_config = {
            ...
            "whitelist": {"instance_ids": ["i-1234567890abcdef0"]},
            "schedule": {
...
class TestInputValidation(unittest.TestCase):
    ...
    def test_validate_instance_id_format(self):
        ...
        self.assertEqual(validate_instance_id("i-0abc123def456789a"), "i-0abc123def456789a")

        # Valid 8-char format (older)
        self.assertEqual(validate_instance_id("i-12345678"), "i-12345678")
...
class TestRemediatorIntegration(unittest.TestCase):
    ...
    def test_sanitize_for_json(self):
        ...
        data = {
            ...
            "items": [{"date": date(2025, 1, 14)}, {"date": date(2025, 1, 15)}],
        }
...
class TestLoggingIntegration(unittest.TestCase):
    ...
    def test_log_remediation_action(self):
        ...
        try:
            log_remediation_action(
                action_type="reject", recommendation_ids=[1, 2, 3], result=result, dry_run=True
            )
        except Exception as e:
