...
def minimum_risk_for(action: str, environment: Optional[str], owner: Optional[str] = None) -> str:
...
def validate_risk_level(
    action: str, environment: Optional[str], displayed_risk: str, owner: Optional[str] = None
) -> str:
...
def assess_confidence(
    ...
    if (
        observation_days is not None
        and min_observation_days is not None
